    ...
    <div className="relative pb-3">
        <div className=" pt-2 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
            ...
            <article className="flex flex-col space-y-2 w-full ">
              ...
              I'm a cybersecurity master's student passionate about keeping digital spaces safe.
              I also have some experience with web development.
              </p>
              <p className="text-sm leading-7 text-center md:text-start">
              I love solving tough security problems and want to use my skills 
              in both cybersecurity and web development to make the internet safer and better for everyone.
              I'm excited to learn and grow in this fast-changing field
              </p>
            </article>
